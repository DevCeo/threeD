...
export default function example() {
  ...
  const pointLight = new THREE.PointLight("aliceblue", 1, 50, 2);
  ...
  // radius는 부드럽게 처리가능
  // pointLight.shadow.radius = 15; // 기본값인 THREE.PCFShadowMap에서만 적용
  ...
  gui.add(pointLight.position, "x", -5, 5, 0.1).name("빛 X");
  gui.add(pointLight.position, "y", -5, 5, 0.1).name("빛 Y");
  gui.add(pointLight.position, "z", 2, 10, 0.1).name("빛 Z");
