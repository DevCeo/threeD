...
export default function example() {
  ...
  const rectAreaLight = new THREE.RectAreaLight("florawhite", 3, 3, 3);
  ...
  gui.add(rectAreaLight.position, "x", -5, 5, 0.1).name("빛 X");
  gui.add(rectAreaLight.position, "y", -5, 5, 0.1).name("빛 Y");
  gui.add(rectAreaLight.position, "z", 2, 10, 0.1).name("빛 Z");
  ...
  function draw() {
    ...
    // rectAreaLight.position.x = Math.cos(time) * 5;
    // rectAreaLight.position.z = Math.sin(time) * 5;
